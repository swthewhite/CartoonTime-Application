...
enum class ActivityType(val intentCreator: (Context) -> Intent?) {
    ...
    RECEIVE({ context ->
        Intent(
            context,
            com.alltimes.cartoontime.ui.view.ReceiveActivity::class.java
        )
    }),
    CHARGE({ context ->
        Intent(
            context,
            com.alltimes.cartoontime.ui.view.ChargeActivity::class.java
        )
    }),
    SIGNUP({ context ->
        Intent(
            context,
            com.alltimes.cartoontime.ui.view.SignUpActivity::class.java
        )
    }),
}